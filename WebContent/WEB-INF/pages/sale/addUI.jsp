...
<html>
 ...
 <body class="main">
	...
	<form:form id="chanceForm" action="${ctp }/sale/chance/${chance.id }" method="POST" modelAttribute="chance">
		...
		<table class="query_form_table" border="0" cellPadding="3" cellSpacing="0">
			...
			<tr>
				<th>创建人</th>
				<td>
					${loginUser.name }(${loginUser.role.name })
					<input type="hidden" name="createBy.id" value="${loginUser.id }"/>
				</td>
				<th>创建时间</th>
